    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.rightSide}>
                ...
                <SignUp modalState={isSignUpModalOpen} modalCancel={modalCancel} modalOk={modalOk} />
                <SignIn modalState={isSignInModalOpen} modalCancel={modalCancel} modalOk={modalOk} />
            </div>
        </div>
    );
}
